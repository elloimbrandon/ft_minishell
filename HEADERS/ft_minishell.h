...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/31 20:49:09 by brfeltz           #+#    #+#             */
/*   Updated: 2020/01/31 20:50:52 by brfeltz          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					check_path_build_path(char **path, char **input_copy,
						t_env *env);
...
char				*exp_tilde_check(char *input_copy, t_cmd *input_check,
						t_env *env);
...
void				check_env_tilde_qoutes(char *input_copy,
						t_cmd *input_check);
void				is_tilde_qoutes(char *input_copy, t_env *env,
						t_cmd *input_check);
void				check_bultin(char **input_copy, t_cmd *input_check,
						t_env *env);
void				check_cd_cmd(char **input_copy, t_cmd *input_check,
						t_env *env);
...
void				ft_parse_mini_2(t_env *env, t_cmd *input_check,
						char **input);
void				ft_parse_input(t_env *env, t_cmd *input_check,
						char **input_copy);
void				ft_remove_qoutes(char *input_copy);
void				ft_print_echo(char **input_copy,
						t_cmd *input_check);
void				ft_local_exec(char **input_copy, t_cmd *input_check,
						t_env *env);
